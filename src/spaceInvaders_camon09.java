...
public class spaceInvaders_camon09 extends PApplet {
	...
	/*
	 * Versi\u00f3n del juego cl\u00e1ssico SPACE INVADERS programado para el
	 * taller Processing y Arduino en CAMON de Alacant, que el autor impartido
	 * por Quelic Berga, Daniel Garc\u00eda i Joan Soler-Adillon
	 * http://www.tucamon.es/contenido/processing-y-arduino
	 * 
	 * Autor: Joan Soler-Adillon [www.joan.cat] Enero 2009 Licencia: Creative
	 * Commons, Attribution-Noncommercial-Share Alike 3.0 Unported
	 * http://creativecommons.org/licenses/by-nc-sa/3.0/
	 * 
	 * Este programa est\u00e1 dise\u00f1ado para ser utilitzado tanto por
	 * usuarios noveles como avanzados. Para los primeros, existen una serie de
	 * variables al principio de todo (bajo el t\u00edtulo de
	 * "variables principales" que determinan todos los aspectos importantes de
	 * juego. S\u00f3lo manipulando estos valores se ver\u00e1n cambios
	...
	spaceShip nave = new spaceShip(theWidth / 2, theHeight
			- spaceShipDistanceToBottom, spaceShipSpeed, delayBetweenBullets);
	// im\u00e1genes
	...
	public void setup() {
		...
		for (int i = 50; i < 200; i += 30) {
			for (int j = 75; j < 550; j += 50) {
				invaders[invaderCount] = new invader(this, j, i, invaderCount,
						invadersSpeed, invadersSpeedIncrement, invadersYStep);
